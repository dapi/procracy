...
6.1. История транзакций публична и неизменяема (append-only).
6.2. Любой гражданин может запросить аудит банковской системы.
6.3. Аудит проверяет соответствие `balances.json` истории транзакций
